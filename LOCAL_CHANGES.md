...
- Voice-note Settings list microphone sources so recording can use a specific working input without changing the system default. Near-silent capture is rejected with an actionable error before sending.
